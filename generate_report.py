...
# -------------------------------------------------------------
# Git allows the same person to commit using different author
# names. These mappings make the report treat those identities
# as one person.
#
# IMPORTANT:
# - "Tanvi Mathur" and "tanvimathur2006" are the SAME contributor.
# - "TanuShree2154" remains a separate contributor.
# -------------------------------------------------------------

AUTHOR_MAPPING = {
    "Tanvi Mathur": "tanvimathur2006",
    "tanvimathur2006": "tanvimathur2006",
    "TanuShree2154": "TanuShree2154",
}


def normalize_author(author):
    """
    Converts different Git author names belonging to the same
    contributor into one consistent report name.
    """
    author = author.strip()
...
def get_git_metrics(interval="weekly"):
    ...
    for line in raw_output.strip().split('\n'):
        ...
        if line.startswith('COMMIT|||'):
            ...
            if (
                "bot" in raw_author.lower()
                or "github-actions" in raw_author.lower()
            ):
            ...
            # tanvimathur2006
            #
            # Both therefore become one contributor.
            # -------------------------------------------------

            current_author = normalize_author(raw_author)
